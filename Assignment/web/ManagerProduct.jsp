<%-- 
    ...
    Created on : Mar 14, 2024, 8:18:53 PM
    Author     : thang
--%>
        ...
        <div class="container">
            <div class="table-wrapper">
                ...
                <div class="clearfix">
                    ...
                    <ul class="pagination">
                        <li class="page-item ${tag==1?"disabled":""}"><a href="manager?index=${tag-1}">Previous</a></li>
                            <c:forEach begin="1" end="${endP}" var="i">
                            <li class="page-item ${tag==i?"active":""}"><a href="manager?index=${i}" class="page-link">${i}</a></li>
                            </c:forEach>
                        <li class="page-item ${tag==endP?"disabled":""}"><a href="manager?index=${tag+1}" class="page-link">Next</a></li>
                    </ul>
                </div>
            </div>
