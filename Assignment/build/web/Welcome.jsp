        ...
        <jsp:include page="Menu.jsp"></jsp:include>
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="home">Sub-category</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <jsp:include page="Left.jsp"></jsp:include>
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                        <c:forEach items="${requestScope.allproduct}" var="o">
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card">
                                    <img class="card-img-top" src="${o.image}" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="detail?id=${o.id}" title="View Product">${o.name}</a></h4>
                                        <p class="card-text show_txt">${o.describe}
                                        </p>
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-danger btn-block">${o.price} USD</p>
                                            </div>
                                            <div class="col">
